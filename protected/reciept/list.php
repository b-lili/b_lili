...
<?php 
	$query = "SELECT sutemeny.id, sutemeny.sutinev, sutemeny.hozzavalok, sutemeny.elkeszitesi_ido, sutemeny.nehezseg, users.email FROM sutemeny INNER JOIN users ON sutemeny.szerzo_id = users.id";
