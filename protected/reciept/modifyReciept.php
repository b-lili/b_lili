...
if(!array_key_exists('r', $_GET) || empty($_GET['r'])) : 
	...
	$query = "SELECT id, sutinev, hozzavalok, elkeszitesi_ido, nehezseg, szerzo_id FROM sutemeny WHERE id = :id";
	$params = [':id' => $_GET['r']]; 
	require_once DATABASE_CONTROLLER; 
		...
		<form method="post">
				...
				<div class="form-row">
					<div class="form-group col-md-12">
				    	...
				    	<select class="form-control" id="nehezseg" name="nehezseg" value=<?=$sutemeny['nehezseg'] ?>>
				...
				<div class="form-row">
					<div class="form-group col-md-12">
						...
						<input type="text" class="form-control" id="szerzo_id" name="szerzo_id" value="<?=$sutemeny['szerzo_id'] ?>">
					</div>
				</div>
